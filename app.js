...
io.on("connection", (socket) => {
  socket.on("drawing", (data) =>{ // server listening for an event called "drawing" wich will be define in sketch.js
    socket.broadcast.emit("drawing", data); // .broadcast: Sends the message to everyone except the sender.
    console.log(data);
  });
});
